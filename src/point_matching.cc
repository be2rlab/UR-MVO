...
PointMatching::PointMatching(SuperGlueConfig &superglue_config)
...
int PointMatching::MatchingPoints(
  ...
  Eigen::Matrix<double, 259, Eigen::Dynamic> norm_features0 =
      NormalizeKeypoints(features0, _superglue_config.image_width,
                         _superglue_config.image_height);
  Eigen::Matrix<double, 259, Eigen::Dynamic> norm_features1 =
      NormalizeKeypoints(features1, _superglue_config.image_width,
                         _superglue_config.image_height);
...
Eigen::Matrix<double, 259, Eigen::Dynamic> PointMatching::NormalizeKeypoints(
