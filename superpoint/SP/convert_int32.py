...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='script to convert superpoint onnx model to int32')
    parser.add_argument('--model_path', help="onnx file (.onnx)")
    parser.add_argument('--output_path', default="output", help="int32 onnx model file output directory")
    args = parser.parse_args()
    convert_model_to_int32(model_path=args.model_path, out_path=args.output_path)
